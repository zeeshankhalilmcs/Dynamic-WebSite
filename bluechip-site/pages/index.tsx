...
export default function Home(){
  return (
    <div>
      ...
      <AnnouncementBar />
      <WhoWeAre />
      <main className="w-full bg-slate-900 px-8 py-20 lg:px-12 lg:py-32">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="rounded-xl border border-cyan-500/30 bg-slate-800/60 p-6 backdrop-blur-sm transition hover:border-cyan-400/50 hover:bg-slate-800/80">
