  ...
  plans: [
    {
      ...
      ctaHref: '/contact',
      features: ['Core workflow setup', 'Standard support', 'Operational reporting', 'Essential automation'],
    ...
    },
    {
      ...
      featured: true,
      badge: 'Most popular',
      features: ['Everything in LaunchPad', 'AI virtual assistance', 'AI email handling', 'AI follow-up workflows', 'Branch extensibility'],
